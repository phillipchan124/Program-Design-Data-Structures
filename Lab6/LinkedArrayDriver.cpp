...
int main()
{
  ...
  LinkedArray<int> b;
  cout << "Output size and capacity" << endl;
  cout << "Expected capacity: 0  size: 0" << endl;
  ...
  cout << "Expected capacity: 13 size: 4" << endl;
  cout << "Actual capacity: " << a.capacity()
  << " size: " << a.size() << endl << endl;
  assert( 13 == a.capacity() );

  {
    cout << "Display the values in linked array." << endl;
    LinkedArray<int> copy = a;
